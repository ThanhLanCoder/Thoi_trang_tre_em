...
(4, '2', 4, 'ngonnn', '2019-05-16 19:28:13'),
(4, '2', 1, 'Chưa tốt! cần cải thiện nhiều', '2019-05-16 19:29:30'),
(2, '2', 4, 'Giảm giá 500k , quá gắt <3', '2019-05-16 19:31:48'),
(33, '2', 4, 'Đỏ may mắn <3', '2019-05-16 19:32:58'),
(21, '4', 5, 'wow,giá ngon đây rồi <3', '2019-05-16 19:38:03'),
(4, '4', 4, 'đẹp', '2019-05-16 19:47:56'),
(2, '4', 3, 'aaa g <3', '2019-05-16 19:48:46'),
(21, '4', 3, 'hihi', '2019-05-16 19:49:20'),
(33, '4', 2, 'kakaka ', '2019-05-16 19:49:44'),
(15, '4', 4, 'đẹp', '2019-05-16 19:52:14');
...
(4, 'Mới ra mắt', 'MoiRaMat', 50000, '2019-05-01 00:00:00', '2019-05-31 00:00:00');
...
(1, 'Chanel', 'chanel.png', 'Các sản phẩm của chanel'),
(2, 'D&G', 'd&g.png', 'Các sản phẩm của D&G'),
(3, 'Dior', 'dior.png', 'Các sản phẩm đến từ Dior'),
(4, 'Fendi', 'fendi.png', 'Các sản phẩm của Fendi'),
(5, 'Gucci', 'gucci.png', 'Các sản phẩm của gucci'),
(6, 'Louis', 'louis.png', 'Các sản phẩm của Louis'),
(7, 'Prada', 'prada.png', 'Các sản phẩm của Prada');
-- --------------------------------------------------------
...
(1, 'Thanh', 'Lan', '', '0123456789', '', '', 'thanhlan', '202cb962ac59075b964b07152d234b70', 1, 1),
(2, 'Admin', '', '', '', '', '', 'admin', '202cb962ac59075b964b07152d234b70', 2, 1);
...
INSERT INTO sanpham (MaSP, MaLSP, TenSP, DonGia, SoLuong, HinhAnh, MaKM, MauSac, Size, SoSao, SoDanhGia, TrangThai) VALUES
(1, 7, 'Áo khoác trẻ em mùa đông', 349000, 10, 'img/products/sp1.png', 4, 'Hồng', 'M', 0, 0, 1),
(2, 7, 'Váy công chúa ren', 769000, 10, 'img/products/sp2.png', 2, 'Đỏ', 'L', 4, 2, 1),
(3, 2, 'Bộ đồ ngủ hình thú', 479000, 10, 'img/products/sp3.png', 2, 'Nâu', 'S', 0, 0, 1),
(4, 1, 'Áo dài cách tân trẻ em', 3199000, 10, 'img/products/sp4.png', 3, 'Trắng', 'XL', 3, 3, 1),
(5, 3, 'Áo thun cổ tròn in họa tiết', 629000, 10, 'img/products/sp5.png', 2, 'Vàng', 'M', 0, 0, 1),
(6, 6, 'Quần jean trẻ em', 1199000, 10, 'img/products/sp6.png', 2, 'Xanh đậm', 'L', 0, 0, 1),
(7, 7, 'Bộ thể thao năng động', 469000, 10, 'img/products/sp7.png', 4, 'Xanh lá', 'S', 0, 0, 1),
(8, 1, 'Váy hoa mùa hè', 669000, 10, 'img/products/sp8.png', 4, 'Hồng nhạt', 'M', 0, 0, 1),
(9, 1, 'Áo khoác chống nắng trẻ em', 899000, 10, 'img/products/sp9.png', 4, 'Tím', 'L', 0, 0, 1),
(10, 3, 'Set áo và quần yếm', 1299000, 10, 'img/products/sp10.png', 1, 'Xám', 'S', 0, 0, 1),
(11, 1, 'Áo sơ mi trẻ em', 1700000, 10, 'img/products/sp11.png', 3, 'Trắng', 'M', 0, 0, 1),
(12, 7, 'Bộ đồ mặc nhà thoải mái', 349000, 10, 'img/products/sp12.png', 4, 'Hồng', 'L', 0, 0, 1),
(13, 1, 'Bộ đồ nỉ ấm áp', 249000, 10, 'img/products/sp13.png', 1, 'Xanh da trời', 'M', 0, 0, 1),
(14, 6, 'Quần short trẻ em', 285000, 10, 'img/products/sp14.png', 2, 'Đỏ', 'S', 0, 0, 1),
(15, 7, 'Váy xòe tiệc cưới', 260000, 10, 'img/products/sp15.png', 2, 'Hồng nhạt', 'L', 4, 1, 1),
(16, 7, 'Bộ đồ hè năng động', 569000, 10, 'img/products/sp16.png', 1, 'Cam', 'M', 0, 0, 1),
(17, 5, 'Quần dài kẻ sọc', 479000, 10, 'img/products/sp17.png', 1, 'Xám', 'L', 0, 0, 1),
(18, 2, 'Bộ đồ cosplay dễ thương', 999999, 10, 'img/products/sp18.png', 2, 'Đen', 'M', 0, 0, 1),
(19, 3, 'Váy ren vintage', 899000, 10, 'img/products/sp19.png', 4, 'Be', 'S', 0, 0, 1),
(20, 6, 'Áo len mùa đông', 749000, 10, 'img/products/sp20.png', 2, 'Nâu', 'M', 0, 0, 1),
(21, 6, 'Áo hoodie trẻ em', 1099000, 10, 'img/products/sp21.png', 4, 'Xám', 'L', 0, 0, 1),
(22, 6, 'Bộ đồ giữ nhiệt', 329000, 10, 'img/products/sp22.png', 4, 'Đen', 'M', 0, 0, 1),
(23, 4, 'Áo thun tay dài trẻ em', 959000, 10, 'img/products/sp23.png', 3, 'Xanh', 'S', 0, 0, 1),
(24, 5, 'Quần kaki trẻ em', 339000, 10, 'img/products/sp24.png', 2, 'Be', 'M', 0, 0, 1),
(25, 7, 'Váy dạ hội nhỏ xinh', 749000, 10, 'img/products/sp25.png', 2, 'Hồng', 'L', 3, 2, 1),
(26, 2, 'Bộ đồ thú cưng', 449000, 10, 'img/products/sp26.png', 1, 'Cam', 'S', 0, 0, 1),
(27, 3, 'Set áo hoodie và quần jogger', 1299000, 10, 'img/products/sp27.png', 4, 'Xám', 'M', 0, 0, 1),
(28, 1, 'Áo khoác phao trẻ em', 1159000, 10, 'img/products/sp28.png', 2, 'Tím', 'L', 0, 0, 1),
(29, 5, 'Bộ đồ thun dễ thương', 999000, 10, 'img/products/sp29.png', 3, 'Hồng nhạt', 'S', 0, 0, 1),
(30, 6, 'Áo len cổ tròn', 319000, 10, 'img/products/sp30.png', 2, 'Nâu', 'M', 0, 0, 1),
(31, 7, 'Váy ren tầng trẻ em', 679000, 10, 'img/products/sp31.png', 4, 'Đỏ', 'L', 0, 0, 1),
(32, 5, 'Quần thun co giãn', 259000, 10, 'img/products/sp32.png', 1, 'Trắng', 'S', 0, 0, 1),
(33, 2, 'Bộ đồ hóa trang Halloween', 949000, 10, 'img/products/sp33.png', 3, 'Đen', 'M', 0, 0, 1),
(34, 6, 'Áo thun in họa tiết thú vị', 799000, 10, 'img/products/sp34.png', 3, 'Vàng', 'L', 0, 0, 1),
(35, 5, 'Bộ đồ cotton thoáng mát', 329000, 10, 'img/products/sp35.png', 2, 'Xanh dương', 'M', 0, 0, 1),
(36, 3, 'Váy len mùa đông', 799000, 10, 'img/products/sp36.png', 4, 'Đen', 'S', 0, 0, 1),
(37, 1, 'Áo khoác có mũ trẻ em', 1259000, 10, 'img/products/sp37.png', 4, 'Xám', 'L', 0, 0, 1),
(38, 7, 'Váy xòe công chúa', 1599000, 10, 'img/products/sp38.png', 1, 'Tím nhạt', 'M', 0, 0, 1),
(39, 6, 'Quần jeans ống đứng', 459000, 10, 'img/products/sp39.png', 2, 'Xanh đậm', 'L', 0, 0, 1);
